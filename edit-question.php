<?php
 include("app/controllers/edit.php");
?>
<!doctype html>
<html lang="ru">
  <head>
    ...
    <title>Изменить статью - AnswerNest</title>
...
<div class="container">
  ...
  <a class="to-main-page" href="index.php">Отмена</a>
    <h2>Изменение статьи</h2>
        ...
        <form class="create-question-form" method="post" action="edit-question.php?id=<?php echo $id?>" enctype="multipart/form-data">
        <p class="errortext"><?php echo $errorMessage;?></p>
                ...
                <div class="col">
                    ...
                    <select name="topic" aria-label="Default select example">
                            <option value="<?php echo $topicId;?>" selected><?php echo $topicName;?></option>
                            <?php
                            topicShowForSelected();
                            ?>
                        </select>
                    <div class="col-12">
                        <button name="edit-post-button" class="btn-create-question" type="submit">Сохранить изменения</button>
                    </div>
