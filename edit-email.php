...
<div class="container">
    <div class="row profile">
        ...
        <div class="profile-info">
            <ul>
            <li>Имя пользователя: <br><strong><?php echo $_SESSION['login'];?>  </strong><a href="edit-username.php" class="edit-profile"> Изменить</a></li>
                <form method="post" action="edit-email.php">
                    <p><?php echo $errorMessage;?><p>
                    <input name="email" placeholder="<?php echo $_SESSION['email']?>" value="<?php echo $email?>">
                    <button class="edit-username-button" type="submit" name="edit-email-button">Изменить</button>
                    <a class="cancel-edit" href="profile.php?id=<?php echo $_GET['id'];?>">Отменить</a>
                </form>
                <li><p class="description-user">Описание: <br><strong><?php echo $_SESSION['description'];?>  </strong></p></li>
