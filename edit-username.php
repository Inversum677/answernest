        ...
        <div class="profile-info">
            <ul>
                ...
                <p><?php echo $errorMessage;?><p>
                    <input  name="username" placeholder="<?php echo $_SESSION['login']?>" value="<?php echo $username?>">
                    <button class="edit-username-button" type="submit" name="edit-username-button">Изменить</button>
