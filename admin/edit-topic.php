        ...
        <div class="row">
          ...
          <?php
            ...
            <div class="posts col-md-9 col-12">
                ...
                <form method="post" action="edit-topic.php">
                    <input value="<?php echo $id;?>" name="id" type="hidden">
                  <input value="<?php echo $name;?>" name="edit-topic-name" class="col-md-9 create-topic-input" placeholder="Введите название категории">
                  <button name="edit-topic-button" type="submit" class="create-topic-button col-md-2">Изменить</button>
