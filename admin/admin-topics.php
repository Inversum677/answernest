  ...
  <body>
    <div class="container">
        <div class="row">
          ...
          <a class="exit-panel add-topic-button" href="<?php echo BASE_URL . "admin/create-topic.php"; ?>">Добавить категорию</a>
          ...
          <?php
            ...
            <div class="posts col-md-9 col-12">
                ...
                <div class="row title-table">
                    ...
                    <div class="username col-md-7">Имя категории</div>
    ...
    <script scr="../assets/script/script.js">
      <script
